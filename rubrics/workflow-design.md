...
1. Deterministic code. Rubric not written.
...
3. Local GPU. Rubric not written.
4. Subscription-based model, the lowest-cost model that does the job well. Rubric not written.
5. Pay-per-use tokens. Rubric not written.
